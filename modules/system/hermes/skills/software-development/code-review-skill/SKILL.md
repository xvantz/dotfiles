...
description: |
  Comprehensive code review guidance for React 19, Next.js, Vue, Svelte, NestJS,
  TypeScript, Go, Python, and 20+ ecosystems. Architecture review, performance,
  security audit, code quality anti-patterns. Use when reviewing PRs, code
  changes, or conducting full codebase reviews.
trigger: "User asks to review code, conduct a code review, audit a PR or codebase, or check security/performance/architecture of code."
allowed-tools:
  - Read
  - Grep
  - Glob
