...
trigger: Use when working with shadcn-svelte components, adding UI components via CLI (pnpm dlx shadcn-svelte add), Bits UI components, or SvelteKit UI component libraries.
---
